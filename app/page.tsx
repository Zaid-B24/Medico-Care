  ...
  return (
    <div className="flex h-screen max-h-screen">
      ...
      <div className="sub-container max-w-[496px]">
        <Image alt="patient" className="mb-12 h-10 w-fit" src='/assets/icons/logo-full.svg' height={1000} width={1000} />
        <PatientForm></PatientForm>
        <div className="text-14-regular mt-29 flex justify-between">
